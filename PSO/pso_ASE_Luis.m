...
%Ltx_i=unifrnd(rmin, rmax, 1,K);% Length of the fibers from the star coupler to the user, Tx
Ltx_i= [48.8779
   26.9518
   40.0057
   46.3947
...
%Lrx_i=unifrnd(rmin, rmax, 1, K);% Length of the fibers from the star coupler to the user, Rx
Lrx_i=[32.0586
    4.8504
   45.3027
   43.6605
